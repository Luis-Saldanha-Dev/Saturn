      ...
      <Container>
        <GenericHTML>
          ...
          <p>
            ...
            <strong>Francesco Cirillo</strong>, que consiste em dividir o trabalho em
            blocos de tempo (os famosos "Pomodoros") intercalados com pausas. O objetivo é
            manter o foco total por um período curto e garantir descansos para evitar o
            cansaço mental.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>4. A cada 4 ciclos, faça uma pausa longa</strong> (geralmente 15 a
              30 minutos).
            </li>
          </ul>
          ...
          <p>
            ...
            que quiser! Basta acessar a <RouterLink href='/settings'>página de configurações</RouterLink> e
          ...
          <p>
            Assim, você sempre sabe em que parte do processo está e o que vem a seguir.
            Não precisa mais anotar no papel ou ficar calculando de cabeça!
          </p>

          <h3>📊 Histórico automático</h3>
          <p>
            Todas as suas tarefas e ciclos concluídos ficam salvos no{' '}
            <RouterLink href='/history'>histórico</RouterLink>, com status de completas ou interrompidas.
